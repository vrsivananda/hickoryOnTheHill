...
class Ocean_Extra_Scripts_Panel {
	...
	public function update_scripts() {
		...
		$scripts_settings 	= ( ! empty( get_option('oe_scripts_settings') ) ) ? get_option('oe_scripts_settings') : array();
		$scripts 			= array_intersect_key( $scripts_settings, self::get_scripts() );
	...
	public function generate_js() {
		...
		// Get js directory uri from Github to avoid conflict with some host for security purpose
		$tDir = 'https://raw.githubusercontent.com/oceanwp/oceanwp/master/assets/js/';
	...
	public static function generate_css() {
		...
		// Get css directory uri from Github to avoid conflict with some host for security purpose
		$tSass 	= 'https://raw.githubusercontent.com/oceanwp/oceanwp/master/sass/';
		$tDir 	= $tSass .'components/';
		$cssDir = 'https://raw.githubusercontent.com/oceanwp/oceanwp/master/assets/css/';
